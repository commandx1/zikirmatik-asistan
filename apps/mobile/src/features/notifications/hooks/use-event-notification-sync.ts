...
//  - serverPushActive değiştiğinde (push kaydı sonradan tamamlanır/logout
//    olur): resync tekrar tetiklenir, özel gün zamanlaması buna göre kurulur
//    ya da iptal edilir.
...
export function useEventNotificationSync() {
  ...
  const serverPushActive = usePushRegistrationStore((state) => state.serverPushActive);
