...
import { computeLocalBadges } from "./local-badges";
import type { ZikirItem } from "../../focus/types";

/** Builds the guest-mode (local, non-authenticated) stats summary from the on-device dhikr items. */
export function buildLocalStatsSummary(
  items: ZikirItem[],
