  ...
  return (
    <View className="mb-8 items-center">
      ...
      <View className="relative z-10 -mt-5">
          ...
          >
            ...
            >
              <View className="mb-2 w-full flex-row justify-end gap-1">
                ...
                <View className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: withAlpha(tokens.textPrimary, 0.2) }} />
                <View className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: withAlpha(tokens.textPrimary, 0.2) }} />
              </View>
                ...
                >
                  ...
                  >
                    ...
                    {!home.isTargetMode ? (
                      ...
                      <Text className="mt-1 text-[10px] font-semibold tracking-[0.6px]" style={{ color: tokens.success }}>
        ...
        <View className="absolute -right-2 top-[70px] h-11 w-2 rounded-r" style={{ backgroundColor: sideButtonPrimary }} />
        <View
