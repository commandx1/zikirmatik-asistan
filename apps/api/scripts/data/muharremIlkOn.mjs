  ...
  dhikrItems: [
    {
      ...
      tags: ['aşure', 'muharrem', 'yılbaşı', 'nefis', 'şeytan', 'dua', 'özel gün'],
      categories: ['dua', 'ibadet', 'özel gün', 'aşure', 'muharrem'],
      timeOfDay: ['sabah', 'ogle'],
      recommendedCount: 1,
      suitableFor: ['aşure günü', 'muharrem'],
    },
    {
      ...
      tags: ['muharrem', 'hicri yılbaşı', 'korunma', 'güven', 'ayetel kürsi', 'kandil', 'ramazan', 'özel gün', 'kadir gecesi'],
      categories: ['özel gün', 'muharrem', 'kuran', 'ramazan', 'oruç', 'kandil', 'kadir gecesi', 'arefe'],
      timeOfDay: 'any',
      recommendedCount: 360,
      suitableFor: ['korunma', 'güven', 'hicri yılbaşı', 'muharrem ilk 10', 'nazar ve vesvese', 'ev koruması', 'ramazan', 'kadir gecesi'],
    },
    {
      ...
      tags: ['muharrem', 'tesbih', 'hamd', 'tekbir', 'özel gün'],
      categories: ['özel gün', 'muharrem', 'tesbih'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['şükür', 'muharrem ilk 10', 'manevi denge', 'muharrem'],
    },
    {
      key: keyMap.YA_SELAM,
      ...
      tags: ['muharrem', 'esma', 'selamet', 'barış', 'özel gün'],
      categories: ['özel gün', 'muharrem', 'esma'],
      timeOfDay: 'any',
      recommendedCount: 313,
      suitableFor: ['huzur', 'muharrem ilk 10', 'barış niyeti', 'muharrem'],
    },
    {
      ...
      tags: ['muharrem', 'esma', 'rahmet', 'merhamet', 'özel gün'],
      categories: ['özel gün', 'muharrem', 'esma'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['merhamet', 'muharrem ilk 10', 'kalp yumuşaması', 'muharrem'],
    },
    {
      key: keyMap.TEVHID,
      ...
      tags: ['muharrem', 'tevhid', 'risalet', 'aidiyet', 'bayram', 'kandil', 'ramazan', 'özel gün', 'zilkade ayı girişi', 'rebiülevvel ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
      categories: ['özel gün', 'tevhid', 'ramazan', 'oruç', 'bayram', 'zilkade', 'muharrem', 'kandil', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['iman tazeleme', 'aidiyet', 'kandil gecesi', 'tefekkür', 'özel gün', 'ramazan', 'muharrem', 'kurban bayramı', 'mevlid kandili', 'zilkade ayı girişi', 'rebiülevvel ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
    },
    {
      ...
      tags: ['muharrem', 'kuran', 'selamet', 'umut', 'özel gün'],
      categories: ['özel gün', 'muharrem', 'kuran'],
      timeOfDay: 'any',
      recommendedCount: 41,
      suitableFor: ['umut', 'muharrem ilk 10', 'manevi teselli', 'muharrem'],
    },
    {
      key: keyMap.SEHADET,
      nameArabic:
      ...
      tags: ['muharrem', 'aşure', 'iman', 'şehadet', 'özel gün'],
      categories: ['özel gün', 'muharrem', 'tevhid'],
      timeOfDay: 'any',
      recommendedCount: 33,
      suitableFor: ['aşure günü', 'iman tazeleme', 'muharrem ilk 10', 'muharrem'],
    },
    {
      ...
      tags: ['aşure', 'muharrem', 'tevekkül', 'korunma', 'yardım', 'özel gün'],
      categories: ['dua', 'zikir', 'özel gün', 'aşure', 'muharrem'],
      timeOfDay: 'any',
      recommendedCount: 70,
      suitableFor: ['aşure günü', 'tevekkül', 'ilahi yardım talebi', 'korunma', 'muharrem'],
    },
    {
      ...
      tags: ['aşure', 'muharrem', 'tesbih', 'arş', 'mizan', 'özel gün'],
      categories: ['zikir', 'tesbih', 'özel gün', 'aşure', 'muharrem'],
      timeOfDay: 'any',
      recommendedCount: 10,
      suitableFor: ['aşure günü', 'tesbih', 'tefekkür', 'muharrem ilk 10', 'muharrem'],
    },
    {
      ...
      tags: ['aşure', 'muharrem', 'enbiya', 'kurtuluş', 'şefaat', 'dua', 'özel gün'],
      categories: ['dua', 'ibadet', 'özel gün', 'aşure', 'muharrem'],
      timeOfDay: ['sabah', 'ogle'],
      recommendedCount: 1,
      suitableFor: ['aşure günü', 'sıkıntı giderme', 'kurtuluş niyeti', 'enbiya vesilesi', 'muharrem'],
    },
    {
