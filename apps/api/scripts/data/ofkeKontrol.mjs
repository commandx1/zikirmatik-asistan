  ...
  dhikrItems: [
    {
      ...
      nameTurkish: "Eûzü Billâhi",
      transliteration: "Eûzü billâhi mine'ş-şeytânirracîm.",
      meaning: "Rahmetten kovulmuş şeytanın şerrinden Allah'a sığınırım.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: "Kalbimin Öfkesini Gider Duası",
      transliteration:
        "Allâhümme Rabbe Muhammedin, iğfir lî zenbî ve ezhib gayza kalbî ve ecirnî min mudıllâti'l-fiten.",
      meaning:
        "Ey Muhammed'in Rabbi olan Allah'ım! Günahımı bağışla, kalbimin öfkesini gider ve beni saptırıcı fitnelerin şerrinden koru.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: "Öfke Anında Hak Sözü Söyleme Duası",
      transliteration:
        "Allâhümme innî es'elüke kelimete'l-hakkı fir-ridâ vel-ğadab.",
      meaning:
        "Allah'ım! Senden hem hoşnutluk hem de öfke anında hak ve doğru sözü söylemeyi dilerim.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: "Hayy-Kayyûm İstiğfarı",
      transliteration:
        "Estağfirullâhe'l-azîmellezî lâ ilâhe illâ hüve'l-Hayye'l-Kayyûme ve etûbü ileyh.",
      meaning:
        "Kendisinden başka hiçbir ilah olmayan, diri (Hayy) ve her şeyi ayakta tutan (Kayyûm) yüce Allah'tan bağışlanma diler ve O'na tövbe ederim.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: "Hz. Lokman'ın Sabır Öğüdü",
      transliteration:
        "Yâ büneyye ekımi's-salâte ve'mur bil-ma'rûfi venhe ani'l-münkeri vasbir alâ mâ esâbek. İnne zâlike min azmi'l-ümûr.",
      meaning:
        "Yavrum! Namazı dosdoğru kıl; iyiliği emret, kötülüğü yasakla ve başına gelenlere sabret. Doğrusu bunlar, azmedilmesi gereken işlerdendir.",
      virtue:
