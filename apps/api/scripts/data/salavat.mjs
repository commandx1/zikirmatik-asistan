  ...
  dhikrItems: [
    {
      ...
      tags: ['kurban bayramı', 'salavat', 'recep', 'rajab', 'şaban', 'kandil', 'bayram', "sha'ban", 'ramazan', 'ramadan', 'özel gün', 'zilhicce', 'eid al-fitr', 'eid al-adha', 'mawlid week', 'kadir gecesi', 'eyyâm-ı biyd', 'ayyam al-bid', 'dhu al-hijjah', 'laylat al-qadr', 'mevlid haftası', 'mawlid al-nabi', "laylat al-mi'raj", 'safer ayı girişi', "laylat al-ragha'ib", 'zilkade ayı girişi', 'üç ayların başlangıcı', 'safer ilk çarşamba gecesi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'beginning of rabi al-awwal', 'beginning of rabi al-akhir', 'beginning of jumada al-ula', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı', 'beginning of jumada al-akhira', 'first wednesday night of safar', 'beginning of the month of safar', 'the beginning of the three holy months', "beginning of the month of dhu al-qi'dah"],
      categories: ['özel gün', 'bayram', 'recep', 'üç aylar', 'kandil', 'regaib', 'cuma', 'miraç', 'şaban', 'ramazan', 'oruç', 'kadir gecesi', 'zilkade', 'zilhicce', 'hac', 'muharrem', 'eyyam-ı biyd', 'safer', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['gün boyu', 'namaz sonrası', 'peygamber sevgisi', 'manevi huzur', 'dua öncesi', 'dua kabulü', 'kalp huzuru', 'bereket', 'rahmet', 'şefaat ümidi', 'manevi yakınlık', 'iç ferahlığı', 'cuma günü', 'salih amel', 'sünnete bağlılık', 'manevi güçlenme', 'recep', 'rajab', 'şaban', "sha'ban", 'ramazan', 'ramadan', 'zilhicce', 'eid al-fitr', 'eid al-adha', 'mawlid week', 'kadir gecesi', 'eyyâm-ı biyd', 'ayyam al-bid', 'miraç kandili', 'dhu al-hijjah', 'regaib kandili', 'laylat al-qadr', 'kurban bayramı', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi', "laylat al-mi'raj", 'safer ayı girişi', "laylat al-ragha'ib", 'zilkade ayı girişi', 'üç ayların başlangıcı', 'safer ilk çarşamba gecesi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'beginning of rabi al-awwal', 'beginning of rabi al-akhir', 'beginning of jumada al-ula', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı', 'beginning of jumada al-akhira', 'first wednesday night of safar', 'beginning of the month of safar', 'the beginning of the three holy months', "beginning of the month of dhu al-qi'dah"],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'bereket', 'peygamber sevgisi', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['salavat', 'peygamber sevgisi', 'manevi bereket', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      key: keyMap.MUNCIYE,
      nameArabic:
      ...
      tags: ['mevlid kandili', 'salavat', 'korunma', 'münciye', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi', "laylat al-bara'ah"],
      categories: ['kandil', 'özel gün', 'salavat', 'dua', 'berat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 41,
      suitableFor: ['afetlerden korunma', 'korku anları', 'emniyet duası', 'mawlid week', 'berat kandili', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi', "laylat al-bara'ah"],
    },
    {
    ...
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'kemal', 'bereket', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['salavat hatmi', 'manevi bereket', 'peygamber sevgisi', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'delail', 'muhabbet', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['muhabbet ehli niyeti', 'salavat programı', 'kandil gecesi', 'manevi bereket', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'nur', 'tefekkür', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 10,
      suitableFor: ['zihinsel berraklık', 'manevi nur talebi', 'tefekkür', 'kapalı kapıların açılması', 'sıkıntı ve belaların def edilmesi için', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'feth', 'hidayet', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['hidayet talebi', 'zor işlerin açılması', 'manevi destek', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'ehlibeyt', 'muhabbet', 'kandil', 'özel gün', 'mawlid week', 'mawlid al-nabi', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['ehlibeyt muhabbeti', 'derin salavat', 'kandil gecesi', 'mawlid week', 'mevlid kandili', 'mawlid al-nabi', 'mevlid haftası'],
    },
    {
      ...
      tags: ['mevlid kandili', 'berat-kandili', 'salavat', 'ruya', 'gece-ibadeti', 'kandil', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'night',
      recommendedCount: 100,
      suitableFor: ['yatmadan önce', 'rüya niyeti', 'gece zikri', 'kandil gecesi', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'ferahlik', 'şifa', 'kandil', 'özel gün', 'mawlid week', 'mevlid haftası', 'mawlid al-nabi'],
      categories: ['kandil', 'özel gün', 'salavat', 'dua', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 41,
      suitableFor: ['sıkıntıların giderilmesi', 'şifa niyeti', 'hacet duası', 'işlerin kolaylaşması', 'kaza ve belalardan korunma', 'duaların kabul olması', 'geçim darlığının sona ermesi', 'mawlid week', 'mevlid haftası', 'mevlid kandili', 'mawlid al-nabi'],
    },
    {
      ...
      tags: ['şaban', 'salavat', '27. gece', 'şefaat', "sha'ban", 'özel gün'],
      categories: ['salavat', 'ibadet', 'özel gün', 'şaban', 'üç aylar'],
