  ...
  dhikrItems: [
    {
      ...
      tags: ['kurban bayramı', 'salavat', 'recep', 'şaban', 'kandil', 'bayram', 'ramazan', 'özel gün', 'zilhicce', 'kadir gecesi', 'eyyâm-ı biyd', 'mevlid haftası', 'safer ayı girişi', 'zilkade ayı girişi', 'üç ayların başlangıcı', 'safer ilk çarşamba gecesi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
      ...
      suitableFor: ['gün boyu', 'namaz sonrası', 'peygamber sevgisi', 'manevi huzur', 'dua öncesi', 'dua kabulü', 'kalp huzuru', 'bereket', 'rahmet', 'şefaat ümidi', 'manevi yakınlık', 'iç ferahlığı', 'cuma günü', 'salih amel', 'sünnete bağlılık', 'manevi güçlenme', 'recep', 'şaban', 'ramazan', 'zilhicce', 'kadir gecesi', 'eyyâm-ı biyd', 'miraç kandili', 'regaib kandili', 'kurban bayramı', 'mevlid haftası', 'mevlid kandili', 'safer ayı girişi', 'zilkade ayı girişi', 'üç ayların başlangıcı', 'safer ilk çarşamba gecesi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'bereket', 'peygamber sevgisi', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['salavat', 'peygamber sevgisi', 'manevi bereket', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      key: keyMap.MUNCIYE,
      nameArabic:
      ...
      tags: ['mevlid kandili', 'salavat', 'korunma', 'münciye', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'dua', 'berat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 41,
      suitableFor: ['afetlerden korunma', 'korku anları', 'emniyet duası', 'berat kandili', 'mevlid haftası', 'mevlid kandili'],
    },
    {
    ...
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'kemal', 'bereket', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['salavat hatmi', 'manevi bereket', 'peygamber sevgisi', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'delail', 'muhabbet', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['muhabbet ehli niyeti', 'salavat programı', 'kandil gecesi', 'manevi bereket', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'nur', 'tefekkür', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 10,
      suitableFor: ['zihinsel berraklık', 'manevi nur talebi', 'tefekkür', 'kapalı kapıların açılması', 'sıkıntı ve belaların def edilmesi için', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'feth', 'hidayet', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['hidayet talebi', 'zor işlerin açılması', 'manevi destek', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'ehlibeyt', 'muhabbet', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['ehlibeyt muhabbeti', 'derin salavat', 'kandil gecesi', 'mevlid kandili', 'mevlid haftası'],
    },
    {
      ...
      tags: ['mevlid kandili', 'berat-kandili', 'salavat', 'ruya', 'gece-ibadeti', 'kandil'],
      categories: ['kandil', 'özel gün', 'salavat', 'mevlid'],
      timeOfDay: 'night',
      recommendedCount: 100,
      suitableFor: ['yatmadan önce', 'rüya niyeti', 'gece zikri', 'kandil gecesi', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'salavat', 'ferahlik', 'şifa', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'salavat', 'dua', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 41,
      suitableFor: ['sıkıntıların giderilmesi', 'şifa niyeti', 'hacet duası', 'işlerin kolaylaşması', 'kaza ve belalardan korunma', 'duaların kabul olması', 'geçim darlığının sona ermesi', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['şaban', 'salavat', '27. gece', 'şefaat', 'özel gün'],
