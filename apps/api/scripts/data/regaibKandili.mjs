  ...
  dhikrItems: [
    {
      ...
      tags: ['regaib kandili', 'recep', 'üç aylar', 'bereket', 'ramazan hazırlığı', 'kandil', 'özel gün', 'recep ayı girişi', 'şaban ayı girişi', 'üç ayların başlangıcı'],
      categories: ['kandil', 'özel gün', 'dua', 'recep', 'üç aylar', 'regaib', 'cuma', 'şaban'],
      timeOfDay: ['sabah', 'aksam', 'gece'],
      recommendedCount: 100,
      suitableFor: ['herkes', 'regaib kandili', 'recep ayı girişi', 'şaban ayı girişi', 'üç ayların başlangıcı'],
    },
    {
      ...
      tags: ['regaib', 'kandil', 'secde', 'tesbih', 'melek', 'özel gün', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
      categories: ['zikir', 'ibadet', 'kandil', 'özel gün', 'regaib', 'cuma', 'safer'],
      timeOfDay: ['gece', 'yatsi'],
      recommendedCount: 70,
      suitableFor: ['herkes', 'regaib kandili', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
    },
    {
      ...
      timeOfDay: ['gece', 'yatsi'],
      recommendedCount: 70,
      suitableFor: ['herkes', 'regaib kandili'],
    },
  ],
  specialDays: [
    {
