  ...
  dhikrItems: [
    {
      ...
      tags: ['eyyam-ı biyd', 'tevhid', 'şirkten korunma', 'gece namazı', 'dolunay', 'özel gün', 'eyyâm-ı biyd', 'ayyam al-bid'],
      ...
      recommendedCount: 4,
      suitableFor: ['tevhid pekiştirme', 'şirkten korunma', 'gece namazı sonrası', 'eyyam-ı biyd', 'eyyâm-ı biyd', 'ayyam al-bid'],
    },
  ],
  specialDays: [
    {
