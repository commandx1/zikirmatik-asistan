  ...
  dhikrItems: [
    {
      ...
      tags: ['mevlid kandili', 'havkale', 'tevekkül', 'teslimiyet', 'kandil', 'ramazan', 'özel gün', 'muharrem', 'safer ayı girişi', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
      categories: ['kandil', 'özel gün', 'tevekkül', 'ramazan', 'oruç', 'muharrem', 'safer', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['acziyet bilinci', 'tevekkül', 'zorlanma anları', 'ruhani daralma', 'fakirlikten korunma', 'ramazan', 'muharrem', 'mevlid kandili', 'safer ayı girişi', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
    },
    {
      ...
      tags: ['mevlid kandili', 'kuran', 'sure', 'teselli', 'kandil'],
      categories: ['kandil', 'özel gün', 'kuran', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 50,
      suitableFor: ['manevi ferahlık', 'tefekkür', 'kandil gecesi', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'dua', 'korunma', 'sığınma', 'kandil'],
      categories: ['kandil', 'özel gün', 'dua', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 33,
      suitableFor: ['vesveseden korunma', 'manevi korunma', 'gece ibadeti', 'panik', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'kuran', 'ayet', 'sabır', 'takva', 'kandil'],
      categories: ['kandil', 'özel gün', 'kuran', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 10,
      suitableFor: ['sabır', 'sebat', 'manevi disiplin', 'mevlid kandili'],
    },
    {
      key: keyMap.AHZAB_56,
      nameArabic:
      ...
      tags: ['mevlid kandili', 'kuran', 'ayet', 'salavat', 'peygamber sevgisi', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'kuran', 'salavat', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 10,
      suitableFor: ['salavat bilinci', 'peygamber sevgisi', 'kandil gecesi', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'dua', 'tevbe', 'merhamet', 'kandil', 'ramazan', 'özel gün'],
      categories: ['kandil', 'özel gün', 'dua', 'istiğfar', 'ramazan', 'oruç', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['tevbe', 'pişmanlık', 'merhamet talebi', 'ramazan', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'dua', 'sabır', 'rahmet', 'kandil'],
      categories: ['kandil', 'özel gün', 'dua', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['sıkıntı anları', 'sabır', 'rahmet talebi', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'tesbih', 'tahmid', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'tesbih', 'mevlid'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['şükür', 'zikir meclisi', 'kandil gecesi', 'mevlid haftası', 'mevlid kandili'],
    },
    {
      ...
      tags: ['mevlid kandili', 'dua', 'muhabbet', 'kandil', 'özel gün', 'mevlid haftası'],
      categories: ['kandil', 'özel gün', 'dua', 'mevlid'],
      timeOfDay: 'night',
      recommendedCount: 100,
      suitableFor: ['muhabbet', 'ahlak niyeti', 'gece duası', 'mevlid haftası', 'mevlid kandili'],
    },
  ],
  specialDays: [
    {
