  ...
  dhikrItems: [
    {
      ...
      tags: ['ramazan', 'hilal', 'dua', 'ay', 'giriş', 'özel gün', 'ramazan ayı girişi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'beginning of rabi al-awwal', 'beginning of rabi al-akhir', 'beginning of jumada al-ula', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı', 'beginning of jumada al-akhira', 'beginning of the month of ramadan'],
      categories: ['ibadet', 'oruç', 'özel gün', 'ramazan'],
      timeOfDay: ['aksam'],
      recommendedCount: 7,
      suitableFor: ['herkes', 'oruç tutanlar', 'ramazan ayı girişi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'beginning of rabi al-awwal', 'beginning of rabi al-akhir', 'beginning of jumada al-ula', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı', 'beginning of jumada al-akhira', 'beginning of the month of ramadan'],
    },
    {
      ...
      tags: ['ramazan', 'oruç', 'niyet', 'özel gün', 'ramazan ayı girişi', 'beginning of the month of ramadan'],
      categories: ['ibadet', 'oruç', 'özel gün', 'ramazan'],
      timeOfDay: ['gece', 'sabah'],
      recommendedCount: 7,
      suitableFor: ['oruç tutanlar', 'herkes', 'ramazan ayı girişi', 'beginning of the month of ramadan'],
    },
  ],
  specialDays: [
    {
