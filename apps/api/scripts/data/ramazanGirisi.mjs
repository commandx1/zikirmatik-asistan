  ...
  dhikrItems: [
    {
      ...
      tags: ['ramazan', 'hilal', 'dua', 'ay', 'giriş', 'özel gün', 'ramazan ayı girişi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
      categories: ['ibadet', 'oruç', 'özel gün', 'ramazan'],
      timeOfDay: ['aksam'],
      recommendedCount: 7,
      suitableFor: ['herkes', 'oruç tutanlar', 'ramazan ayı girişi', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
    },
    {
      ...
      tags: ['ramazan', 'oruç', 'niyet', 'özel gün', 'ramazan ayı girişi'],
      categories: ['ibadet', 'oruç', 'özel gün', 'ramazan'],
      timeOfDay: ['gece', 'sabah'],
      recommendedCount: 7,
      suitableFor: ['oruç tutanlar', 'herkes', 'ramazan ayı girişi'],
    },
  ],
  specialDays: [
    {
