  ...
  dhikrItems: [
    {
      ...
      tags: ['safer', 'aylık dua', 'korunma', 'bereket', 'giriş', 'özel gün', 'safer ayı girişi'],
      categories: ['dua', 'özel gün', 'korunma', 'safer'],
      timeOfDay: ['sabah', 'aksam'],
      recommendedCount: 100,
      suitableFor: ['safer ayı', 'bela koruması', 'manevi genişlik', 'herkes', 'safer ayı girişi'],
    },
    {
      key: keyMap.SAFER_BISMILLAH_LA_YEDURRU,
      nameArabic:
      ...
      tags: ['safer', 'korunma', 'sabah-akşam', 'bela', 'son çarşamba', 'nazar', 'dua', 'şifa', 'ani rahatsızlık', 'kaza', 'özel gün', 'safer ayı girişi', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
      categories: ['dua', 'korunma', 'özel gün', 'genel', 'hastalık', 'safer'],
      timeOfDay: ['sabah', 'aksam', 'gece'],
      recommendedCount: 100,
      suitableFor: ['safer ayı', 'bela koruması', 'son çarşamba', 'herkes', 'sabah akşam', 'ani belalara karşı', 'nazar korunması', 'ani rahatsızlık ve kaza', 'zehirlenme korunması', 'safer ayı girişi', 'safer ilk çarşamba gecesi', 'safer son çarşamba gecesi'],
    },
    {
      ...
      tags: ['safer', 'korunma', 'esma', 'bela', 'dua', 'özel gün', 'safer ayı girişi'],
      categories: ['dua', 'korunma', 'özel gün', 'safer'],
      timeOfDay: 'any',
      recommendedCount: 1,
      suitableFor: ['safer ayı', 'bela koruması', 'semavi koruma', 'herkes', 'safer ayı girişi'],
    },
    {
      key: keyMap.YA_HALIK,
      ...
      tags: ['safer', 'esma', 'son çarşamba', 'korunma', 'özel gün', 'safer son çarşamba gecesi'],
      categories: ['zikir', 'esma', 'özel gün', 'safer'],
      timeOfDay: ['gece', 'yatsi'],
      recommendedCount: 100,
      suitableFor: ['safer ayı', 'son çarşamba', 'ilahi koruma', 'herkes', 'safer son çarşamba gecesi'],
    },
    {
      key: keyMap.SAFER_HASBUNALLAH_VEKIL,
    ...
    },
    {
      ...
      tags: ['safer', 'son çarşamba', 'şifa suyu', 'korunma', 'bela', 'hastalık', 'özel gün', 'safer son çarşamba gecesi'],
      categories: ['dua', 'korunma', 'şifa', 'özel gün', 'safer'],
      timeOfDay: ['gece', 'sabah'],
      recommendedCount: 1,
      suitableFor: ['safer ayı', 'son çarşamba', 'şifa niyeti', 'bela koruması', 'safer son çarşamba gecesi'],
    },
  ],
  specialDays: [
    {
      ...
      dhikrKeys: [
        ...
        keyMap.SAFER_BISMILLAH_LA_YEDURRU,
    ...
    },
    {
      ...
      description: {
        tr: "Safer'in ilk çarşamba gecesi teheccüd vaktinde 4 rekat kılınır: her rekatta Fatiha + 17x Kevser + 5x İhlas + 1x Felak + 1x Nas. {hijriYear}'de 1 Safer, çarşambaya denk gelmektedir.",
        en: "On the first Wednesday night of Safar, a four-rakat prayer is performed at the time of Tahajjud: in each rakat al-Fatihah + 17x al-Kawthar + 5x al-Ikhlas + 1x al-Falaq + 1x an-Nas. In {hijriYear}, the 1st of Safar falls on a Wednesday.",
      },
      eventFamily: 'safer-ayi',
      priority: 148,
      dhikrKeys: [
    ...
    },
    {
      ...
      type: 'özel gün',
      hijriRule: { type: 'last-weekday-on-or-before-month-end', month: 'safer', weekday: 'wednesday' },
      description: {
