  ...
  dhikrItems: [
    {
      ...
      tags: ['kurban bayramı', 'tesrik', 'tekbir', 'gönle huzur', 'kalbe sevinç', 'ilahî şükür', 'bayram'],
      categories: ['özel gün', 'bayram', 'ramazan', 'oruç'],
      timeOfDay: 'any',
      recommendedCount: 23,
      suitableFor: ['bayram günleri', 'cemaat sonrası zikir', '', 'kurban bayramı', 'ramazan bayramı'],
    },
    {
      ...
      tags: ['kurban bayramı', 'tesbih', 'hastalıktan korunma', 'rızık ve bereket', 'korku ve vesvese tedavisi', 'bayram', 'özel gün', 'rebiülahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
      categories: ['özel gün', 'bayram', 'ramazan', 'oruç'],
      timeOfDay: 'morning',
      recommendedCount: 300,
      suitableFor: ['bayram sabahı', 'tesbihat', 'allah sevgisi', 'günahların bağışlanması', 'kurban bayramı', 'ramazan bayramı', 'rebiülahir ayı başlangıcı', 'cemaziyelevvel ayı başlangıcı'],
    },
    {
      ...
      tags: ['kurban bayramı', 'istiğfar', 'tevbe', 'şaban', 'bayram', 'ramazan', 'özel gün', 'hicri yılbaşı', 'zilkade ayı girişi', 'üç ayların başlangıcı', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı'],
      categories: ['özel gün', 'bayram', 'recep', 'üç aylar', 'şaban', 'ramazan', 'oruç', 'zilkade', 'muharrem'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['bayram günü', 'tevbe', 'günahların bağışlanması', 'şaban', 'ramazan', 'hicri yılbaşı', 'kurban bayramı', 'zilkade ayı girişi', 'üç ayların başlangıcı', 'rebiülahir ayı başlangıcı', 'rebiülevvel ayı başlangıcı', 'cemaziyelahir ayı başlangıcı'],
    },
    {
      ...
      tags: ['kurban bayramı', 'şükür', 'dua', 'bayram'],
      categories: ['özel gün', 'bayram'],
      timeOfDay: 'any',
      recommendedCount: 7,
      suitableFor: ['kurban kesimi sonrası', 'şükür', 'hamd', 'kurban bayramı'],
    },
    {
      ...
      tags: ['kurban bayramı', 'tevekkül', 'hasbiye', 'bayram'],
      categories: ['özel gün', 'bayram'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['gün boyu', 'zorlanma anları', 'tevekkül', 'endişe anları', 'kurban bayramı'],
    },
    {
      key: keyMap.HASBIYE,
      nameArabic:
      ...
      tags: ['kurban bayramı', 'hasbiye', 'tevekkül', 'dua', 'bayram', 'zilhicce', 'özel gün'],
      categories: ['özel gün', 'bayram', 'dua', 'tevekkül', 'zilhicce', 'hac'],
      timeOfDay: 'any',
      recommendedCount: 100,
      suitableFor: ['tevekkül', 'endişe anları', 'rahmet talebi', 'korunma', 'sükunet', 'zilhicce', 'kurban bayramı'],
    },
  ],
  specialDays: [
    {
