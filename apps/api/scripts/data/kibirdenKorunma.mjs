  ...
  dhikrItems: [
    {
      ...
      nameTurkish: 'Şeytanın Hemz, Nefh ve Nefsinden Sığınma',
      transliteration:
        "Allâhümme innî eûzü bike mineş-şeytânir-racîmi min hemzihî ve nefhihî ve nefsih.",
      meaning:
        "Allah'ım! Kovulmuş şeytanın dürtmesinden (delilik), üflemesinden (kibir) ve nefes vermesinden (şiir/boş ilham) sana sığınıyorum.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: 'Kibrin Üflemesinden Sığınma',
      transliteration:
        'Allâhümme innî eûzü bike min nefhatil kibriyâ.',
      meaning:
        "Ey Allah'ım! Kibrin üflemesinden sana sığınıyorum.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: 'Yâ Kuddûs',
      transliteration: 'Yâ Kuddûs',
      meaning: "Hatadan, gafletten, acizlikten uzak ve her türlü eksiklikten pek temiz olan.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: 'Halîm ve Kerîm Tevhid Zikri',
      transliteration:
        "Lâ ilâhe illallâhül halîmül kerîm. Ve sübhânallâhi rabbis-semâvâtis-seb'i ve rabbil arşil azîm. Velhamdülillâhi rabbil âlemîn.",
      meaning:
        "Halîm ve Kerîm olan Allah'tan başka ilah yoktur. Yedi kat göğün Rabbi ve yüce Arş'ın Rabbi olan Allah'ı noksan sıfatlardan tenzih ederim. Hamd, âlemlerin Rabbi olan Allah'a mahsustur.",
      virtue:
    ...
    },
    {
      ...
      nameTurkish: "Vallâhu Gâlibun Alâ Emrihî",
      transliteration: "Vallâhu gâlibun alâ emrihî.",
      meaning:
        "Allah, kendi emrini/işini yerine getirmeye kadirdir; O'nun hükmü her şeye galiptir.",
      virtue:
